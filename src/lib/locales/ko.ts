export const ko: Record<string, string> = {
  ...
  'chat.builtInAgentDesc': '기본 제공 · 월간 사용량 제한',
  'chat.registeredModels': '등록된 모델',
  'chat.monthlyUsage': '이번 달 사용량',
  'chat.monthlyLimitExceeded': '⚠️ 이번 달 AI 사용량 한도에 도달했습니다. 다음 달 1일에 자동으로 초기화됩니다. 개인 Google AI API Key를 설정에서 입력하면 제한 없이 사용할 수 있습니다.',
